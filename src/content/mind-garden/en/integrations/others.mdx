...
import { Aside, Tabs, TabItem, Steps } from '@yohn-maistre/astro-pure-fork/user'
...
```astro
---
import { MediumZoom } from '@yohn-maistre/astro-pure-fork/advanced'
---
...
See [Friend Links #Integrated with `Friend-Circle-Lite`](/mind-garden/integrations/links#integrated-with-friend-circle-lite).
